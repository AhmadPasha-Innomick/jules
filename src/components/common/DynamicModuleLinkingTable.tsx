...
interface DynamicTableProps<T extends object> {
    ...
    searchType?: "searchby" | "group_name" | "module_name";
    onSearchTypeChange?: (
        type: "searchby" | "group_name" | "module_name"
    ) => void;
}
...
function DynamicGroupTable<T extends object>({
    ...
    const isSearchEnabled = searchInput.trim().length > 0;
        ...
        renderTopToolbarCustomActions: () => (
            ...
            >
                    ...
                    <div className="relative">
                        <input
                            ...
                            placeholder={
                                searchType === "searchby"
                                    ? "Select search"
                                    : `Search by ${searchType === "group_name" ? "Group Name" : "Module Name"
                                    }`
                            }
             ...
             disabled:bg-gray-100 disabled:cursor-not-allowed"
                        ...
                        {searchInput && (
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    onGlobalFilterChange?.(searchInput.trim());
                                }}
                    ...
                    <Tooltip title={isSearchEnabled ? "Search" : "Select search type & enter value"}>
                        <span>
                            <IconButton
