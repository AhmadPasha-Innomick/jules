...
export default function FullScreenModal() {
  ...
  return (
    <ComponentCard title="Full Screen Modal">
      ...
      >
        <div className="fixed top-0 left-0 flex h-screen w-full flex-col justify-between overflow-x-hidden overflow-y-auto bg-white p-6 lg:p-10">
          <div>
            <h4 className="text-title-sm mb-7 font-stc-bold text-gray-800">
              Modal Heading
            </h4>
