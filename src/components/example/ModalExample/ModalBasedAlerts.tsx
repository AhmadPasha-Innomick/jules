    ...
    <ComponentCard title="Modal Based Alerts">
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          className="bg-success-500 shadow-theme-xs hover:bg-success-600 rounded-lg px-4 py-3 text-sm font-stc-medium text-white"
        >
          Success Alert
        </button>
        <button
          onClick={infoModal.openModal}
          className="bg-blue-light-500 shadow-theme-xs hover:bg-blue-light-600 rounded-lg px-4 py-3 text-sm font-stc-medium text-white"
        >
          Info Alert
        </button>
        <button
          onClick={warningModal.openModal}
          className="bg-warning-500 shadow-theme-xs hover:bg-warning-600 rounded-lg px-4 py-3 text-sm font-stc-medium text-white"
        >
          Warning Alert
        </button>
        <button
          onClick={errorModal.openModal}
          className="bg-error-500 shadow-theme-xs hover:bg-error-600 rounded-lg px-4 py-3 text-sm font-stc-medium text-white"
        >
          Danger Alert
        </button>
      </div>
      ...
      >
        <div className="text-center">
          ...
          <h4 className="sm:text-title-sm mb-2 text-2xl font-stc-bold text-gray-800">
            Well Done!
          </h4>
          ...
          <div className="mt-7 flex w-full items-center justify-center gap-3">
            <button
              type="button"
              className="bg-success-500 shadow-theme-xs hover:bg-success-600 flex w-full justify-center rounded-lg px-4 py-3 text-sm font-stc-medium text-white sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
      ...
      >
        <div className="text-center">
          ...
          <div className="mt-7 flex w-full items-center justify-center gap-3">
            <button
              type="button"
              className="bg-blue-light-500 shadow-theme-xs hover:bg-blue-light-600 flex w-full justify-center rounded-lg px-4 py-3 text-sm font-stc-medium text-white sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
      ...
      >
        <div className="text-center">
          ...
          <div className="mt-7 flex w-full items-center justify-center gap-3">
            <button
              type="button"
              className="bg-warning-500 shadow-theme-xs hover:bg-warning-600 flex w-full justify-center rounded-lg px-4 py-3 text-sm font-stc-medium text-white sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
      ...
      >
        <div className="text-center">
          ...
          <div className="mt-7 flex w-full items-center justify-center gap-3">
            <button
              type="button"
              className="bg-error-500 shadow-theme-xs hover:bg-error-600 flex w-full justify-center rounded-lg px-4 py-3 text-sm font-stc-medium text-white sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
