...
import DynamicProductPlanTable from "@/components/common/DynamicProductPlansTable";
...
import { useDeletePrepaidVoice } from "@/hooks/useCreatePlan";
...
export default function SelectedIdTypeLinkingPage() {
    ...
    const deleteMutation = useDeletePrepaidVoice();
    ...
    const {
        ...
        refetch,
        isFetching,
    } = useProductCatalogue("prepaid_voice", apiParams);
    ...
    const rowActions = [
...

        {
            ...
            onClick: (row: any) => {
                ...
                router.push(
                    `/product_catalogue/plans/prepaid_voice_catalogue/view/${row.plan_product_id}`
                );
            }
        ...
        },
        {
            ...
            onClick: (row: any) => {
                ...
                router.push(
                    `/product_catalogue/plans/prepaid_voice_catalogue/edit/${row.plan_product_id}`
                );
            },
        },
    ...
    const handleAddNew = () => router.push("/product_catalogue/plans/prepaid_voice_catalogue/create");
