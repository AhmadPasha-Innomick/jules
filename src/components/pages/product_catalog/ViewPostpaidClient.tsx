                ...
                {plan && (
                    <>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <Detail label="Social Media" value={plan.social_media} />

                            <Detail label="Local Calls" value={plan.local_calls} />
                            <Detail label="STC to STC Calls" value={plan.stc_to_stc_calls} />

                            <Detail label="International Minutes" value={plan.intl_min} />
                            <Detail label="Data Roaming" value={plan.data_roaming} />
                            <Detail label="Roaming Minutes" value={plan.roaming_min} />
