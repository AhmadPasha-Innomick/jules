...
const validationSchema = Yup.object().shape({
    ...
    crm_product_name: Yup.string().required("CRM Product Name is required"),
    crm_product_code: Yup.string().required("CRM Product Code is required"),
    ...
    // ===== ADD THESE 3 NEW VALIDATIONS =====

    intl_min: Yup.string().required("International Minutes is required"),

    data_roaming: Yup.string().required("Data Roaming is required"),

    roaming_min: Yup.string().required("Roaming Minutes is required"),
    ...
    contract_duration: Yup.number()
        ...
        .typeError("Contract Duration must be a number")
...
export default function PlanForm({ onSubmit, onCancel, isSubmitting }: any) {
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <Autocomplete
                    ...
                    renderOption={(props, option: any, { index }) => (
                        <li
                            {...props}
                            key={`${option.plan_product_id}-${index}`}
                        >
                            {option.plan_product_id} - {option.plan_product_name}
                        </li>
                    )}
