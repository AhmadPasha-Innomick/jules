...
const DropzoneComponent: React.FC = () => {
  ...
  return (
    <ComponentCard title="Dropzone">
      <div className="hover:border-brand-500 cursor-pointer rounded-xl border border-dashed border-gray-300 transition">
        <form
          {...getRootProps()}
        ...
        >
          ...
          <div className="dz-message m-0! flex flex-col items-center">
            ...
            <h4 className="text-theme-xl mb-3 font-stc-bold text-gray-800">
            ...
            <span className="text-theme-sm text-brand-500 font-stc-medium underline">
              Browse File
            </span>
          </div>
        </form>
