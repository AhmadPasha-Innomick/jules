  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="shadow-theme-lg absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:w-[361px] lg:right-0"
      >
        <div className="mb-3 flex items-center justify-between border-b border-gray-100 pb-3">
          <h5 className="text-lg font-stc-bold text-gray-800">Notification</h5>
          <button
          ...
          <li>
            ...
            >
              ...
              <span className="block">
                <span className="text-theme-sm mb-1.5 block space-x-1 text-gray-500">
                  <span className="font-stc-medium text-gray-800">
                    Terry Franci
                  </span>
                ...
                <span className="text-theme-xs flex items-center gap-2 text-gray-500">
                  <span>Project</span>
        ...
        <Link
          href="/"
          className="mt-3 block rounded-lg border border-gray-300 bg-white px-4 py-2 text-center text-sm font-stc-medium text-gray-700 hover:bg-gray-100"
        >
